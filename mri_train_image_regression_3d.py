...
parser.add_argument('--config', type=str, default='configs/mri_image_regression_3d.yaml', help='Path to the config file.')
...
for it, (grid, image, _) in enumerate(data_loader):
